.. CTP7 Modules documentation master file, created by
   sphinx-quickstart on Sat Mar 21 17:10:54 2020.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

==========================================
Welcome to the CTP7 modules documentation!
==========================================
...
.. toctree::
   ...
   ctp7_modules (this site) <http://0.0.0.0:8000/SITE_ROOT/docs/api/ctp7_modules/latest>
